...
export const projects = [
  {
    ...
    tech: ["Node.js", "Express.js", "Vanilla JS", "Anthropic analysis API", "Forum Market API"],
    detail:
      "Full backend with HMAC-SHA256 auth, REST API integration, analysis-powered AI risk analysis.",
    highlight:
